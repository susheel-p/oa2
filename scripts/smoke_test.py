...
Checks:
  ...
  3. Core config paths resolve (creates ~/.oa2/ tree).
...
Does NOT test data fetches (network-dependent). Run those manually:
  python -c "from oa2.dataflows.yfinance_options import ...; ..."
"""
...
def test_imports() -> None:
    import oa2  # noqa: F401
    import oa2.core.schemas  # noqa: F401
    import oa2.core.config  # noqa: F401
    import oa2.core.feature_flags  # noqa: F401
    import oa2.watchlist.builder  # noqa: F401
    import oa2.dataflows.cache  # noqa: F401
    import oa2.dataflows.yfinance_options  # noqa: F401
    import oa2.dataflows.sentiment_aggregator  # noqa: F401
    import oa2.dataflows.reddit_fetcher  # noqa: F401
    import oa2.dataflows.stocktwits_fetcher  # noqa: F401
    import oa2.dataflows.moomoo_news_fetcher  # noqa: F401
    import oa2.dataflows.news  # noqa: F401
    import oa2.dataflows.iv_rank_validator  # noqa: F401
    import oa2.graph.pipeline  # noqa: F401
    # moomoo_data imports moomoo SDK; only attempt if installed
    try:
        import oa2.dataflows.moomoo_data  # noqa: F401
    except ImportError as e:
        print(f"    (moomoo_data skipped: {e})")


def test_watchlist() -> None:
    from oa2.watchlist.builder import WATCHLIST, watchlist_summary, is_dealer_signal_ticker
    s = watchlist_summary()
...
def test_config_paths() -> None:
    from oa2.core.config import oa2_home, shadow_log_dir, scan_log_dir, journal_dir
    assert oa2_home().exists()
...
def main() -> int:
    ...
    results = [
        ...
        check("config paths (creates ~/.oa2/)", test_config_paths),
