...
Auto-sync architecture (added 2026-05-19):
    The blacklist and quality scores are kept at ~/.tradingbot/static_blacklist.json
...
# ~/.tradingbot/static_blacklist.json is the source of truth; these are the seed
...
def _static_blacklist_path() -> Path:
    ...
    return tradingbot_home() / "static_blacklist.json"
...
def check_quality_gates(
    ...
    try:
        from tradingbot.learning.rag_context import get_rag_context
        kb = get_rag_context()
