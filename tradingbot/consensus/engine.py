...
Phase A3:  If TRADINGBOT_FLAG_EWMA_CORR=1 and the EWMA tracker has ≥ 20 observations
...
class ConsensusEngine:
    ...
    - TRADINGBOT_FLAG_EWMA_CORR=1 (default True) + tracker warm → live EWMA correlations.
    ...
    def __init__(
        ...
        Args:
            ...
            covariance_tracker: Optional EWMACovariance instance (Phase A3).
                When None, loads from disk if TRADINGBOT_FLAG_EWMA_CORR enabled.
    ...
    def _get_covariance_tracker(self):
        ...
        try:
            from tradingbot.consensus.covariance import EWMACovariance, default_covariance_path
